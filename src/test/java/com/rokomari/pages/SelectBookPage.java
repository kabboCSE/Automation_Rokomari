...
public class SelectBookPage extends CommonMethods {
	
	ExtentTest test;
	public SelectBookPage(ExtentTest test) {
...
//		 @FindBy(xpath="//body[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/a[2]/span[1]"),
		//body[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/a[2]/span[1]
		 @FindBy(xpath="//span[contains(text(),'Place Order')]"),
		 @FindBy(xpath="//img[@class='icon-arrow-right']"),
		 @FindBy(xpath="//a[@id='js-continue-to-shipping']"),
		 @FindBy(xpath="//body[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/a[2]/span[1]"),
		 @FindBy(xpath="//html[1]/body[1]/div[4]/div[1]/div[1]/div[1]/div[2]/div[1]/a[2]")
